...
func (_elem *Element) Attributes() *ElemAttributes {
	value := _elem.jsValue.Get("attributes")
	return NewElemAttributesFromJSNamedNodeMap(value, _elem)
}
...
func (_elem *Element) ScrollRect() (_ret Rect) {
...
func (_elem *Element) ClientRect() (_ret Rect) {
...
func (_elem *Element) BoundingClientRect() (_result *Rect) {
...
func (_elem *Element) ChildrenByTagName(qualifiedName string) (_result *HTMLCollection) {
	_returned := _elem.jsValue.Call("getElementsByTagName", qualifiedName)
...
func (_elem *Element) ChildrenByClassName(classNames string) (_result *HTMLCollection) {
