...
func init() {
	html.RegisterComposer("ick-hero", &Hero{}, []string{"https://cdn.jsdelivr.net/npm/bulma@0.9.4/css/bulma.min.css"})
}
...
func (msg *Hero) RenderContent(out io.Writer) error {
	...
	subtitle := html.NewSnippet("p", `class="title"`).InsertHTML(msg.Subtitle)
