...
type SectionIckImage struct{ SectionIcecakeDoc }

func (cmp *SectionIckImage) RenderContent(out io.Writer) error {
	html.WriteString(out, `<h2>Image</h2>
	<p>ick.Image is an icecake snippet providing the HTML rendering for a `, linkBulmaImage, ` with extra features and usefull Go APIs.</p>`)
