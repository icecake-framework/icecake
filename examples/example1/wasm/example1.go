...
func main() {
	...
	html.RegisterComposer("ick-icecake-brand", html.NewSnippet("a", html.ParseAttributes(`class="brand" href="https://icecake.net"`)).SetContent(html.NewString("<strong>Icecake</strong>")), nil)
