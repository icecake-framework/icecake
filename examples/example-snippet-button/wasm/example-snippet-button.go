...
func main() {
	...
	btn = make([]*bulmaui.Button, 0)
	content := dom.Id("content")

	b0 := bulmaui.NewButton(*html.ToHTML("Click here"), "", "", "")
	...
	b1 := bulmaui.NewButton(*html.ToHTML("Toggle Rounded"), "", "", "")
	...
	b2 := bulmaui.NewButton(*html.ToHTML("Toggle Outlined"), "", "", "")
	...
	b3 := bulmaui.NewButton(*html.ToHTML("Toggle Loading"), "", "", "")
	...
	b4 := bulmaui.NewButton(*html.ToHTML("Toggle Disabled"), "", "", "")
	...
	b5 := bulmaui.NewButton(*html.ToHTML("Go To Home"), "", "/", "")
	b5.SetOutlined(true)
