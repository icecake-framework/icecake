...
func main() {
	...
	b0.Tag().Attributes().SetClasses("m-2 is-link")
	...
	b1.Tag().Attributes().SetClasses("m-2 is-link").SetAttribute("data-example", 1, true)
	...
	b2.Tag().Attributes().SetClasses("m-2 is-link").SetAttribute("data-example", 2, true)
	...
	b3.Tag().Attributes().SetClasses("m-2 is-link").SetAttribute("data-example", 3, true)
	...
	b4.Tag().Attributes().SetClasses("m-2 is-link").SetAttribute("data-example", 4, true)
	...
	b5.SetOutlined(true)
	b5.Tag().Attributes().SetClasses("m-2 is-info").SetAttribute("data-example", 5, true)
